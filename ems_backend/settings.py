...
print("🔍 DEBUG: DB_NAME from .env is →", config('DB_NAME'))
...
SECRET_KEY = 'django-insecure-dy98otfo2ew700c7bstrqm3s9$_#^*0rv7q+)1qqmor5ki)5p9'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:4200",  # or your deployed frontend domain
]
